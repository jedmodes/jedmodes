% diary.sl
% 
% $Id: diary.sl,v 1.1.1.1 2004/10/28 08:16:18 milde Exp $
...
%%% DFA_CACHE_BEGIN %%%
static define setup_dfa_callback_diary (mode)
{
...
static define show_matching_entries(string)
{
   bob();
...
static define show_entries_for_day (month, day, year)
{

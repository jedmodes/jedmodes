...
define reopen_buffer(bmark, ask)
{
   ...
   if (strlen(bmark.file))
     ...
     success = run_function(push_list(bmark.generating_function));
   else
     success = run_function(bmark.generating_function);
...
% debugging functions
#if (expand_jedlib_file("diagnose.sl") != "")
define show_history() 
{
   show(Navigation_Stack);
}
#endif
